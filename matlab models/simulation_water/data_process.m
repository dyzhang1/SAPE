...
data_no_predistortion1 = load('results_withwater_CQI1-3.mat');
throughput_no_predistortion1 = data_no_predistortion1.throughputResults(:, 1:3);

data_no_predistortion2 = load('results_withwater_CQI4-6.mat');
throughput_no_predistortion2 = data_no_predistortion2.throughputResults(:, 1:3);

data_no_predistortion3 = load('results_withwater_CQI7-9.mat');
