...
# 读取两组文件
brate_with, bler_with = extract_brate_bler_from_file("with_mcs28")
brate_without, bler_without = extract_brate_bler_from_file("without_mcs28")
...
plt.legend(prop={'size': 15, 'weight': 'bold'}, frameon=False, loc='best')
plt.xlabel("DL Throughput (Mbps)", fontsize=25)
plt.ylabel("CDF", fontsize=25)
#plt.title("CDF of DL Throughput (brate)", fontsize=28)
plt.legend(fontsize=22)
plt.grid(True)
plt.tight_layout()
plt.setp(plt.gca().get_lines(), linewidth=6)
plt.savefig("brate_mcs28.pdf")
...
#plt.title("CDF of Block Error Rate (BLER)", fontsize=28)
plt.legend(fontsize=22)
plt.grid(True)
plt.tight_layout()
plt.setp(plt.gca().get_lines(), linewidth=6)
plt.savefig("bler_mcs28.pdf")
